...
export const peptides: Peptide[] = [
  ...
  },
  {
    ...
    riskLevel: 'low',
    dosing: { typical: '250-500 mcg/day', method: 'Intranasal spray or subcutaneous injection', cycle: '5-14 day cycles', notes: 'Morning administration recommended. Effects build over 4-12 weeks.' },
  ...
  },
  {
    ...
    primaryUse: 'Sleep promotion and stress reduction',
    trendingRank: 14,
    description: 'A neuropeptide that increases "pressure to sleep" and promotes delta-wave deep sleep. A sleep-promoting modulator, not a sedative.',
    benefits: [
  ...
  },
  {
    ...
    trendingRank: 15,
    description: 'Stimulates GnRH release, increasing LH, FSH, and testosterone. Gaining popularity as HCG alternative for fertility maintenance during TRT.',
    benefits: [
      'Stimulates natural LH and FSH production',
      'Increases testosterone via HPG axis',
      'Maintains fertility during TRT (HCG alternative)',
      'Dose-dependent egg maturation (IVF)',
  ...
  },
  {
    ...
    benefits: [
      'Stimulates fat cell metabolism (lipolysis)',
      'Inhibits new fat formation (lipogenesis)',
      'Preserves muscle tissue during fat loss',
    ...
    riskLevel: 'low',
    dosing: { typical: '250-500 mcg daily', method: 'Subcutaneous injection (abdomen, empty stomach)', cycle: '8-12 weeks', notes: 'Morning on empty stomach. Avoid food 15-20 min after.' },
